...
public:
	...
	enum enEfcType
	{
		enEfcType_STEP = 0,	//asiato.
		enEfcType_PEND_FIRE,//hibana.v
		enEfcType_KICK_HIT,	//kougeki.
		enEfcType_WAVE,		//syougekiha.v
		enEfcType_TRB_OPEN,	//takarabako_1.v
		enEfcType_TRB_LOOP,	//takarabako_2.v
		enEfcType_SLASH,	//teki_kougeki.
		enEfcType_ARBIA_ATK,//Teki_kougeki.
		enEfcType_ENEMY_ATK,//Arbia_kougeki.
		enEfcType_Max,
	};
