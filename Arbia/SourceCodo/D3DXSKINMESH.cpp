...
////ﾘｿｰｽ用ﾎﾞｰﾝ取得関数.
//bool clsD3DXSKINMESH::GetPosFromBoneResouse( char* sBoneName, D3DXVECTOR3* pOutPos, LPD3DXANIMATIONCONTROLLER pAC )
//{
//	// ｱﾆﾒ進行.
//	if( pAC != NULL ){
//		pAC->AdvanceTime( m_dAnimSpeed, NULL );
...
//
//	//ﾎﾞｰﾝ取得.
//	if( GetPosFromBone( sBoneName,  pOutPos ) ){
//		return true;
//	}
//	return false;
//}
...
// フレームの描画.
VOID clsD3DXSKINMESH::DrawFrame(LPD3DXFRAME p, D3DXVECTOR4 &vColor, bool alphaFlg)
{
	MYFRAME*			pFrame = (MYFRAME*)p;
...
//============================================================
void clsD3DXSKINMESH::SetBlend(bool flg)
{
	...
	{
		MessageBox(NULL, "ﾌﾞﾚﾝﾄﾞｽﾃｰﾄ作成失敗", "clsD3DXSKINMESH::SetBlend", MB_OK);
	}
